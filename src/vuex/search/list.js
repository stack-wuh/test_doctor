...
const state = {
  ...
  btnList:[
    ...
    {
      name:'查询重置类别',
      params:['员工列表','快捷回复设置','保险公司','汽车精品管理','精品订单管理','配件大类管理','会员列表','车辆管理','会员充值','积分管理','充值明细','消费明细','奖品卡券管理','用户卡券管理','用户卡券发放','用户奖励','员工奖励','用户提现记录','查看领取明细','用户佣金提现','普通活动','精准获客','活动抽奖','推荐有礼','预约管理','意见反馈','业务开单','业务结算','套餐销售','会员套餐记录'],
      type:'',
      list:[
        {
          text:'查询',
