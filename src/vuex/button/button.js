...
const state = {
  list:[
    ...
    },
    {
      ...
      params:['角色管理','会员充值设置','保养提醒设置','保险公司','快捷回复设置','配件大类管理','预约时间管理','养车知识分类','套餐管理','采购订单','采购入库','采购退货','付款管理','调拨接收','调拨发起','日常盘点','供应商设置','仓库设置','商品分类设置','项目分类设置','物流公司配置','支付方式配置','挂账还款'],
      btn:[
        {
          text:'新增',
          type:'',
    ...
    },
    {
      name:'导出',
      desc:'单独导出按钮',
      params:['精品订单管理', '精品订单详情','充值明细','消费明细','用户奖励','员工奖励','保险服务','检修记录','业务结算','活动中奖','库存报表','出入库明细表','盘点明细表','日报月报','销售统计表','商品销售统计','项目销售统计','采购明细表','挂账单据明细表','挂账还款明细表', '用户统计', '车辆统计','业务统计','活动统计','明细查询'],
      btn:[
        {
          text:'导出',
          type:'',
