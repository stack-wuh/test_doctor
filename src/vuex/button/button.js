...
const state = {
  list:[
    ...
    },
    {
      ...
      params:['角色管理','会员充值设置','保养提醒设置','保险公司','快捷回复设置','配件大类管理','预约时间管理','养车知识分类','套餐管理','采购订单','采购入库','采购退货','供应商设置','仓库设置','商品分类设置','项目分类设置','物流公司配置','支付方式配置'],
      btn:[
        {
          text:'新增',
          type:'',
    ...
    },
    {
      ...
      params:['自动回复配置','汽车精品管理','奖品卡券管理','抽奖模板设置','摇一摇活动','养车知识', '调拨发起', '日常盘点', '调拨接收', '付款管理', '挂账还款'],
      btn:[
        {
          text:'新增',
          type:'',
